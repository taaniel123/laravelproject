    ...
    <form action="/profile/{{ $user->username }}" enctype="multipart/form-data" method="post">
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="row">
                    <h1>Muuda profiili</h1>
                </div>
                <div class="form-group row">
                    <label for="title" class="col-md-4 col-form-label"><strong>Pealkiri</strong></label>
                ...
                <div class="form-group row">
                    <label for="description" class="col-md-4 col-form-label"><strong>Kirjeldus</strong></label>
                ...
                <div class="row">
                    <label for="image" class="col-md-4 col-form-label"><strong>Lisa profiilipilt</strong></label>
